# Generated by Powerlevel10k configuration wizard on 2020-06-16 at 16:51 PDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 62604.
# Wizard options: nerdfont-complete + powerline, large icons, rainbow, ascii, 2 lines,
# disconnected, compact, concise, instant_prompt=off.
